...
3. Send Erin O'Reilly a Slack message (or an email if you must... eoreilly@ucsb.edu) with your new GitHub username so you can be added to the <UNK> GitHub page!
...
If creating a new group library, email Erin (eoreilly@ucsb.edu) and she can directly create the library under the <UNK> account. 
