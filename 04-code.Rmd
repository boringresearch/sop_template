...
All data processing and analysis should be performed with code (i.e., avoid spreadsheets), and all code should be packaged in scripts that are version controlled and follow a style guide. Using code and scripts allows for better organization, documentation, and reproducibility of analysis workflows. **All KRAI code should be stored in the KRAI GitHub account.**
...
data_path <- ifelse(dir.exists(paste0(team_path,"Shared drives/KRAI/projects/current-projects/",project_name)),
                       paste0(team_path,"Shared drives/KRAI/projects/current-projects/",project_name,"/data/"),
                       (paste0(team_path,"Shared drives/KRAI/projects/archived-projects/",project_name,"/data/")))
