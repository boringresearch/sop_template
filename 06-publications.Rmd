...
This section describes best practices related to <UNK> reports and publications.  


## <UNK> Affiliation  


Since <UNK> is joint between MSI and Bren and also its own research entity, we recommend <UNK> staff use the following affiliations for any <UNK> publication:
...
We have created an [<UNK> repository](https://zenodo.org/communities/<UNK>-ucsb/) for all of our reports to live. To upload to the <UNK> community repository, use [this link](https://zenodo.org/deposit/new?c=<UNK>-ucsb) and fill out all of the required information.
...
Generally, <UNK> researchers should be prepared to share a public GitHub repository (see Section 6.4) and a Dryad data repository with publications. The repositories contain code scripts and data (respectively) needed to conduct the study. Increasingly, journals are requiring both sets of documentation at the point of submission or publication. 
...
As with data, we strive to make all our code available. This provides a roadmap of converting input data into tangible results, which may be of interest for external people seeking to replicate our study or for internal <UNK>ers seeking to understand what someone did a few years ago.
...
Any time <UNK> develops publicly available datasets, Shiny apps, or tools, we would love to share these on the <UNK> website. Any time you release a publicly available dataset, Shiny app, or other tool, please Slack or email Erin O'Reilly (eoreilly@ucsb.edu) the following information: name of the dataset app or tool, link, date published, and the <UNK> project it is associated with.
